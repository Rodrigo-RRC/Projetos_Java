...
<body>
  ...
  <div class="accordion">
    <div class="accordion-header" onclick="toggleAccordion()">
      Projetos Java <span class="arrow">▼</span>
    </div>
    <div class="accordion-body" id="accordion-body">
      <button class="project-button" onclick="showPopup('https://github.com/Rodrigo-RRC/Projetos_Java/tree/main/cofrinho_moedas')">Cofrinho de Moedas</button>
      <button class="project-button" onclick="showPopup('https://github.com/Rodrigo-RRC/Projetos_Java/tree/main/sistema_animais')">Sistema de Animais</button>
    </div>
  </div>
